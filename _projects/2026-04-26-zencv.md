...
layout: project
title: "ZenCV"
description: A Chrome extension + FastAPI backend that reads any job posting and instantly crafts a tailored CV and cover letter using LLMs.
date: 2026-04-26
...
The client points `VITE_API_BASE_URL` at the FastAPI server.
...
UPDATE:: I used this project as pilot test. I used it for a month and using this tool I got 3 interviews in just two weeks. So, I thought building a complete product which can be used by other people also would be a good idea. So I scaled it into a full scale product named CogniResue. The extension is published on the Chrome Web Store: [Chrome Web Store listing](https://chromewebstore.google.com/detail/hfbofobaakpiaidpghbafpomddflffla?utm_source=item-share-cb).
